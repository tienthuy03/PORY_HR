      ...
      if (state.isConnected) {
        ...
        if (arrayData.length > 0) {
          ...
          arrayData.forEach(function (item) {
            ...
            axios
              .post(item.url + apiFunction, params, {
                headers: {
                  "content-type": "application/json",
                },
              })
            ...
            <View style={styles.body}>
              <View style={styles.viewInfo}>
                <View>
                  ...
                  <Text style={styles.field}>Mã nhân viên: {emp_id}</Text>
                  <Text style={styles.field}>Mã chấm công: {id_num}</Text>
                </View>
              </View>
              <View style={styles.viewPicture}>
                ...
                {/* <TouchableOpacity
                  ...
                  <Text style={styles.btnChupAnhText}>
                    <Icon name={'face-recognition'} size={18} /> Chụp hình
                  </Text>
                </TouchableOpacity> */}
              </View>
            </View>
