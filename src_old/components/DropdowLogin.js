            ...
            <TouchableOpacity
              ...
              onPress={() => {
                setValue(res.pk),
                  getState({
                    pk: res.pk,
                    ques_code: res.ques_code,
                    ques_name: res.ques_name,
                  });
              }}>
              <Text style={{paddingLeft: 10,fontFamily: 'Roboto-Regular', fontSize: 14, color: Color.mainColor}}>{res.ques_name}</Text>
              {value === res.pk && (
                <View
