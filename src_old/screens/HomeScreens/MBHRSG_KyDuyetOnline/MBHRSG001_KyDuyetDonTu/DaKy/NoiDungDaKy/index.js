...
const NoiDungDaKy = ({ navigation: { goBack }, route }) => {
    ...
    const getDataEmp = () => {
        sysFetch(
            ...
            .then(res => {
                setDataMaster(res.data.danhSach_daKy);
                setDataFile(res.data.file_daKy);

                console.log('Data M', res.data.danhSach_daKy.map(item => ({
        ...
        <Block flex backgroundColor={Color.backgroundColor}>
            ...
            <Block flex backgroundColor={Color.gray}>
                <ScrollView>
                    ...
                    <Block>
                        <TVSListExpand label={'Danh sách nhân viên'}>
                            {dataMaster.map((item) => (
                                <Block>
                                        ...
                                        <Block style={styles.modalOneRecordHeader}>
                                            <Block style={styles.modalOneCol1}>
                                                ...
                                                <Text style={styles.text}>
                                                    {'Trạng thái: '}
                                                    <Text style={[item.approve_status === '3' ? styles.success : item.approve_status === '4' ? styles.danger : '']}>
                                                        {item.approve_status === '3' ? 'Đã xác nhận' : item.approve_status === '4' ? 'Không xác nhận' : ''}
                                                    </Text>
                                                </Text>
