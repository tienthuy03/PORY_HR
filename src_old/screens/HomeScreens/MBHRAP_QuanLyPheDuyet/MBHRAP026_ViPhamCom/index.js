...
import ChoPheDuyet from "../ApproveTabCom/ChoPheDuyet";
import DaPheDuyet from "../ApproveTabCom/DaPheDuyet";
import HetHan from "../ApproveTab/HetHan";
import KhongPheDuyet from "../ApproveTabCom/KhongPheDuyet";
...
const PheDuyetVPC = ({ navigation: { goBack } }) => {
    ...
    <Block flex backgroundColor={Color.backgroundColor}>
      <TVSHeader goBack={goBack}>
        {setHeaderChil2(
          ...
          dataMenuMBHRs,
          "MBHRAP026",
          dataMenuMBHRs.filter((x) => x.menu_cd === "MBHRAP026")[0].p_pk
        )}
      </TVSHeader>
