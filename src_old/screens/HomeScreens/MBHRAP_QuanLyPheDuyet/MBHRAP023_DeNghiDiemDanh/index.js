...
import ChoPheDuyet from "./ChoPheDuyet";
import DaPheDuyet from "./DaPheDuyet";
import KhongPheDuyet from "./KhongPheDuyet";
...
const PheDuyet = ({ navigation: { goBack } }) => {
  ...
  const fetchData = () => {
    ...
    const pro = "SELHRAP023000";

    const in_par = {
      p1_varchar2: currentDate.split("-")[0],
      p2_varchar2: currentDate.split("-")[1],
      ...
      .then((rs) => {
        ...
        if (rs != "Token Expired") {
          ...
          if (rs.results === "S") {
            ...
            rs.data.lst_data.map((item) => {
              switch (item["approve_status_code"]) {
                case "2":
                  count1++;
                  break;
                case "3":
    ...
    <Block flex backgroundColor={Color.backgroundColor}>
      <TVSHeader goBack={goBack}>
        {setHeaderChil2(
          ...
          dataMenuMBHRs,
          "MBHRAP023",
          dataMenuMBHRs.filter((x) => x.menu_cd === "MBHRAP023")[0].p_pk
        )}
      </TVSHeader>
            ...
            data={[
              {
                ...
                screen: (
                  <ChoPheDuyet
                    onReload={() => fetchData()}
                    data={data.filter((x) => x.approve_status_code == "2")}
                    dataOT={dataOT}
                    dataInfo={dataInfo}
              ...
              },
              {
                ...
                screen: (
                  <DaPheDuyet
                    onReload={() => fetchData()}
                    data={data.filter((x) => x.approve_status_code == "3")}
                    dataOT={dataOT}
                    dataInfo={dataInfo}
                    flagReload={flagReload}
                  />
              ...
              },
              {
                ...
                screen: (
                  <KhongPheDuyet
                    onReload={() => fetchData()}
                    data={data.filter((x) => x.approve_status_code == "4")}
                    dataOT={dataOT}
                    dataInfo={dataInfo}
                    flagReload={flagReload}
                  />
