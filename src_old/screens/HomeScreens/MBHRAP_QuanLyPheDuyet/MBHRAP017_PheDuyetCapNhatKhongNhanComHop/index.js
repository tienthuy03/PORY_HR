...
const PheDuyetCapNhatKhongNhanComHop = ({ navigation: { goBack } }) => {
    ...
    <Block flex backgroundColor={Color.backgroundColor}>
      <TVSHeader goBack={goBack}>
        {setHeaderChil2(
          ...
          dataMenuMBHRs,
          "MBHRAP017",
          dataMenuMBHRs.filter((x) => x.menu_cd === "MBHRAP017")[0].p_pk
        )}
      </TVSHeader>
...
export default PheDuyetCapNhatKhongNhanComHop;
