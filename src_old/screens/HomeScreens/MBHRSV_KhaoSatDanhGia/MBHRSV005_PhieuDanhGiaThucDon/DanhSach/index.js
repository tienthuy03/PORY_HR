      ...
      <Block flex marginLeft={10} marginBottom={10} marginRight={10}>
        ...
        >
          ...
          <FlatList
            ...
            // refreshing={false}
            data={dataCriteriaName.filter((x) => x.parent_pk == item.pk)}
  ...
  const renderItemDetail = ({ item }) => {
    return (
      ...
      >
        ...
        {dataCriteriaValue
          .filter((x) => x.ques_code == item.ques_code)
          .map((y) => (
                ...
                <View>
                  ...
                  >
                    ...
                    <View style={{ marginLeft: 3 }}>
                      <Text style={{ opacity: 0.8 }}>{"" + y.ans_nm}</Text>
                    </View>
                  </View>
                </View>
              </View>
