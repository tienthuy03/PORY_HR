...
const ChiTiet = ({ navigation: { goBack }, route }) => {
  ...
  const OnSave = (pk) => {
    ...
    // p_rice_set_type     varchar2,
    // p_start_dt          varchar2,
    // p_meal_method       varchar2,
    // p_new_canteen_code  varchar2,
    // p_set_kind          varchar2,

    // p_num_of_breakfast  number,
    // p_num_of_lunch      number,
    // p_num_of_dinner     number,--10
    // p_num_of_night      number,

    // p_description       varchar2,
    // p_limit_breakfast   varchar2,
    // p_limit_lunch       varchar2,
    // p_limit_dinner      varchar2,
    // p_limit_night       varchar2,--16

    // p_crt_by            varchar2

    const pro = "UPDHRRI009001";
    const in_par = {
      p1_varchar2: "UPDATE",
      p2_varchar2: pk,
  ...
  return (
    <Block flex backgroundColor={Color.gray}>
      <TVSHeader goBack={goBack}>Chi tiết đăng ký mặn</TVSHeader>
      <FlatList
