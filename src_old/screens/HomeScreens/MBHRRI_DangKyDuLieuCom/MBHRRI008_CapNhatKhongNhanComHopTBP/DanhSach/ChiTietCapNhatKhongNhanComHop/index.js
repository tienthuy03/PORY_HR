...
const ChiTiet = ({ navigation: { goBack }, route }) => {
  ...
  const OnDelete = (pk) => {
    ...
    sysFetch(
      ...
      .then((rs) => {
        console.log("rs", rs);
        if (rs.results === "S") {
          dialogNoti("Xóa thành công", true);
  ...
  const onSave = () => {
    ...
    arrSave.forEach(function (item) {
      ...
      lst_thr_emp_pk += item.thr_emp_pk + "|";
      lst_from_dt +=
      ...
      lst_description += item.description + "|";
    });
    ...
    const in_par = {
      ...
      p4_varchar2: lst_from_dt,
      p5_varchar2: lst_to_dt,
      p6_varchar2: lst_description,
      p7_varchar2: lst_reason,
      p8_varchar2: arrSave.length,
      p9_varchar2: APP_VERSION,
      p10_varchar2: crt_by,
    };
  ...
  return (
    <Block flex backgroundColor={Color.backgroundColor}>
      <TVSHeader goBack={goBack}>
        Chi tiết cập nhật không nhận cơm hộp
      </TVSHeader>
