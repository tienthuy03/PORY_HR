...
const ChiTiet = ({ navigation: { goBack }, route }) => {
  ...
  useEffect(() => {
    ...
    setLoai_code(item.meal_method_code);
    setLoai_code_nm(item.meal_method_code_nm);
    ...
    <Block flex backgroundColor={Color.backgroundColor}>
      <TVSHeader goBack={goBack}>
        ...
        {setHeaderChil2(
          ...
          "MBHRRI005",
          menuReducer.data.data.menu.filter((x) => x.menu_cd === "MBHRRI005")[0]
            .p_pk
        ).toLowerCase()}
      </TVSHeader>
