...
const ChiTiet = ({ navigation: { goBack }, route }) => {
  ...
  const [viTriAnDieuChinh_code_nm, setViTriAnDieuChinh_code_nm] =
    useState("Chọn vị trí ăn");
  ...
  useEffect(() => {
    ...
    setLoai_code(item.loai_code);
    setLoai_code_nm(item.loai_code_nm);
  ...
  const onSave = () => {
    ...
    const in_par = {
      ...
      p6_varchar2: loai_code,
      p7_varchar2: viTriAnDieuChinh_code,
      p8_varchar2: lyDo,
      p9_varchar2: ghiChu,
    ...
    <Block flex backgroundColor={Color.backgroundColor}>
      <TVSHeader goBack={goBack}>
        ...
        {setHeaderChil2(
          ...
          "MBHRRI012",
          menuReducer.data.data.menu.filter((x) => x.menu_cd === "MBHRRI012")[0]
            .p_pk
        ).toLowerCase()}
      </TVSHeader>
                      ...
                      dataConfig[0].show_control == "Y" ? (
                        <Block row marginBottom={5}>
                          ...
                          <Block style={{ flex: 0.6 }}>
                            <Block style={styles.titleText}>
                              <Text color={Color.mainColor}>Vị trí ăn</Text>
                            </Block>
                            <TVSList
                              maxHeight={Platform.OS == "ios" ? null : 40}
                              onPress={() =>
                                setModalVisibleViTriAnDieuChinh(true)
                              }
                              colorText={
                                viTriAnDieuChinh_code_nm == "Chọn vị trí ăn"
                                  ? "#B2B2B2"
                                  : null
                              }
