...
const ChoPheDuyet = ({
  ...
  const setDescriptionItem = (itemPk, textDesc) => {
  ...
  const onUpdateData = () => {
    ...
    if (arrData.length > 0) {
      arrData.forEach(function (item) {
        console.log(item['0_approve_note']);
        lstPK += item['0_pk'] + '|';
      ...
      console.log({
        p1_varchar2: 'UPDATE',
        p2_varchar2: lstPK,
        p3_varchar2: lstStatus,
        p4_varchar2: lstNote,
        p5_varchar2: arrData[0]['0_role_type'],
        p6_varchar2: thr_emp_pk,
        p7_varchar2: arrData.length,
      ...
      <>
        ...
        <Block flex marginLeft={10} marginRight={10} marginBottom={10}>
          <Block row justifyContent={'space-between'} alignCenter>
            ...
            {item['0_status'] == '0' ? null : item['0_status'] == '2' ? (
              <Block
                style={{
                  backgroundColor: Color.white,
                ...
                <View style={{padding: 5, marginTop: 10}}>
                  ...
                  <Block
                    ...
                    <TextInput
                      ...
                      onChangeText={text =>
                        setDescriptionItem(item['0_pk'], text)
                      }
                    />
                  </Block>
                </View>
              ...
              {item['0_status'] == '3' ? (
                <View style={{flex: 1}}>
                  <TVSButton
                    ...
                    buttonStyle={'3'}
                    onPress={() => {
                      OnChecked(item['0_pk'], '0', item['0_status']);
                    }}>
                    Huỷ bỏ
                  </TVSButton>
                </View>
                ...
                <View style={{flex: 1}}>
                  <TVSButton
                    ...
                    buttonStyle={'3'}
                    onPress={() => {
                      OnChecked(item['0_pk'], '3', item['0_status']);
                    }}>
                    Chọn không duyệt
                  </TVSButton>
                </View>
              ...
              {item['0_status'] == '2' ? (
                ...
                <View style={{flex: 1}}>
                  <TVSButton
                    ...
                    buttonStyle={'3'}
                    onPress={() => {
                      OnChecked(item['0_pk'], '2', item['0_status']);
                    }}>
                    Chọn phê duyệt
                  </TVSButton>
                </View>
