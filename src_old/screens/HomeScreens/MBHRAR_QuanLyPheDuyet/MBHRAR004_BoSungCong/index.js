...
const PheDuyetBoSungCong = ({ navigation: { goBack } }) => {
  ...
  const [sendMailYN, setSendMailYN] = useState("N");
      ...
      .then((rs) => {
        ...
        if (rs != "Token Expired") {
          ...
          if (rs.results === "S") {
            ...
            // setSendMailYN(rs.data.send_mail);
    ...
    <Block flex backgroundColor={Color.backgroundColor}>
      <TVSHeader goBack={goBack}>
        {setHeaderChil2(
          ...
          dataMenuMBHRs,
          "MBHRAR004",
          dataMenuMBHRs.filter((x) => x.menu_cd === "MBHRAR004")[0].p_pk
        )}
      </TVSHeader>
...
export default PheDuyetBoSungCong;
