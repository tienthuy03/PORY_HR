...
import {
  HRTK004ChonPhongBan,
  HRTK004HidePopupPhongBan,
  HRTK004LayDuLieu,
} from '../../../../../services/redux/HRTK004_BieuDoLaoDong/action';
...
const PopUpPhongBan = () => {
  ...
  const ShowPopupPhongBan = useSelector(
    state => state.HRTK004_BieuDoLaoDongReducer.ShowPopupPhongBan,
  );
  const DanhSachPhongBan = useSelector(
    state => state.HRTK004_BieuDoLaoDongReducer.DanhSachPhongBan,
  );
    ...
    const onSelect = () => {
      sysFetch(
        ...
        .then(rs => {
          ...
          if (rs != 'Token Expired') {
            dispatch(HRTK004ChonPhongBan(item));
            dispatch(HRTK004HidePopupPhongBan());
            dispatch(HRTK004LayDuLieu());
          }
        })
        .catch(error => {
          console.log(error);
        ...
        <View style={styles.container}>
          <View style={styles.content}>
            ...
            <View style={styles.footer}>
              <TouchableOpacity
                style={styles.btnOk}
                onPress={() => dispatch(HRTK004HidePopupPhongBan())}>
