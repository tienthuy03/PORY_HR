...
const PopUpPhongBan = () => {
  ...
  const ShowPopupPhongBan = useSelector(
    (state) => state.HRTK002_ThongKeLuongReducer.ShowPopupPhongBan
  );
  const DanhSachPhongBan = useSelector(
    (state) => state.HRTK002_ThongKeLuongReducer.DanhSachPhongBan
  );
    ...
    const onSelect = () => {
      sysFetch(
        ...
        .then((rs) => {
          ...
          if (rs != "Token Expired") {
            dispatch(HRTK002ChonPhongBan(item));
            dispatch(HRTK002HidePopupPhongBan());
        ...
        <View style={styles.container}>
          <View style={styles.content}>
            ...
            <View style={styles.footer}>
              <TouchableOpacity
                style={styles.btnOk}
                onPress={() => dispatch(HRTK002HidePopupPhongBan())}
              >
