...
const ChiTietCongViec = ({ route, goUpdate }) => {
  ...
  const handleUpdateCongViec = (action) => {
    if (action == 'huyviec') {
      Alert.alert(
        "Thông báo",
        "Bạn có muốn huỷ công việc giao ?",
        [
          {
            text: "Hủy bỏ",
    ...
    if (action == 'giaolai') {
      Alert.alert(
        "Thông báo",
        "Bạn có muốn giao lai công việc?",
        [
          {
            text: "Hủy bỏ",
            onPress: () => console.log("Cancel Pressed"),
  ...
  const fetchUpdateCongViec = (ptram, statusCode) => {
    setModalVisibleUpdateCongViec(false);
    const pro = "UPDHRWO002001";
    const in_par = {
      p1_varchar2: "UPDATE",
      p2_varchar2: ptram,
      p3_varchar2: statusCode,
      ...
      <View style={{
        ...
        <View style={{
          ...
          <View style={{
            ...
            <TVSButton
              type="danger"
              onPress={() => handleUpdateCongViec('huyviec')}
              icon={'cancel'}
              buttonStyle="3"
            >
              Hủy việc
            ...
            <TVSButton
              type="secondary"
              onPress={() => handleUpdateCongViec('giaolai')}
              icon={'restart'}
              buttonStyle="3"
            >
              Giao lại
