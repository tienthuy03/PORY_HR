            ...
            <View style={{
                ...
                <View style={{
                    ...
                    <TVSButton
                        ...
                        icon={"close"}
                        buttonStyle="3"
                        disabled={itemCongViec.tab == 'DaKiemXong' ? true : false}
                    >
                        Hủy công việc
                    </TVSButton>
                    <TVSButton
                        type="success"
                        onPress={() => handleUpdateCongViec('xacnhanhoanthanh')}
                        icon={"content-save"}
                        buttonStyle="3"
                        disabled={itemCongViec.tab == 'DaKiemXong' ? true : false}
                    >
