...
export default function DKNCH({ onCallbackReload }) {
  ...
  const validate = () => {
    ...
    if (toDate === "dd/mm/yyyy") {
      dialogError("Vui lòng chọn đến ngày.");
      return;
    }
  ...
  const onSave = () => {
    console.log({
      ...
      p6_varchar2: convertDate(toDate, "/"),
      p7_varchar2: lyDo,
      p8_varchar2: ghiChu,
      ...
      .then((rs) => {
        ...
        if (rs.results == "F") {
          ...
          if (tablePK == "") {
            ...
            dialogNoti("Đăng ký nhận cơm thành công");
          } else {
