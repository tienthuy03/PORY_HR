...
import DKNCH from "./DangKy";
import DS from "./DanhSach";

const DangNhanComHop = ({ navigation: { goBack } }) => {
    ...
    <Block flex backgroundColor={Color.backgroundColor}>
      <TVSHeader goBack={goBack}>
        {setHeaderChil2(
          ...
          "MBHRRE014",
          menuReducer.data.data.menu.filter((x) => x.menu_cd === "MBHRRE014")[0]
            .p_pk
        )}
      </TVSHeader>
          ...
          data={[
            {
              ...
              name: "Đăng ký",
              count: null,
              screen: <DKNCH onCallbackReload={onCallbackReload} />,
            },
            {
              id: 1,
              name: "Danh sách",
