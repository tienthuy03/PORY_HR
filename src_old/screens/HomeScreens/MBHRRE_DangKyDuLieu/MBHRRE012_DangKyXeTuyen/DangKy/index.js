...
export default function DK({ onCallbackReload }) {
  ...
  const onSave = () => {
    ...
    const in_par = {
      ...
      p8_varchar2: ghiChu,
      p9_varchar2: currentSelectedPerson.approve_role_type,
      p10_varchar2: currentSelectedPerson.thr_emp_pk.toString(),
    ...
    sysFetch(
      ...
      .then((rs) => {
        console.log("rs UPDHRRE012000 ", rs);
        if (rs.results == "F") {
