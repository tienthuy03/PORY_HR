...
const DK_MBHRRE004 = ({currentTab}) => {
  ...
  const {startTime, endTime, description, DanhSachNguoiPheDuyet, limitDate} =
    useSelector(state => state.HRRE004_TangCaReducer);
  ...
  //ot content
  const [otContent, setOtContent] = useState('');
      ...
      sysFetch(
        API,
        {
          ...
          in_par: {
            ...
            p4_varchar2: p_from_date,
            // p5_varchar2: p_to_date,
            p6_varchar2: p_start_time,
            p7_varchar2: p_start_date,
            p8_varchar2: p_end_time,
            p9_varchar2: p_end_date,
            p10_varchar2: otContent,
            p11_varchar2: p_description,
            p12_varchar2: p_crt_by,
            p13_varchar2:
  ...
  const validate = () => {
    ...
    if (otContent.length === 0) {
      Alert.alert('Thông báo', 'Vui lòng nhập nội dung tăng ca.', [
        {text: 'Đóng'},
      ]);
      return;
    }
    ...
    Alert.alert(
      'Thông báo',
      'Bạn có muốn đăng ký tăng ca không?',
      [
        {
          text: 'Đóng',
            ...
            <KeyboardAvoidingView
              ...
              <ScrollView bounces={false} showsVerticalScrollIndicator={false}>
                ...
                <View
                  ...
                  <TextInput
                    multiline={true}
                    placeholder={'Nhập nội dung tăng ca'}
                    value={otContent}
                    onChangeText={text => setOtContent(text)}
                  />
                </View>
                {/* Ghi chú */}
                <Block row justifyCenter alignCenter paddingTop={10}>
                ...
                <View
                  ...
                  <TextInput
                    ...
                    value={description}
                    onChangeText={text => dispatch(HRRE004SetDescription(text))}
                  />
                </View>
