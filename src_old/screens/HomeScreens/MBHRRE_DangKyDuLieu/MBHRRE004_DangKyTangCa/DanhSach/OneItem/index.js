...
import {HRRE004LoadDataTangCa} from '../../../../../../services/redux/HRRE004_TangCa/action';
...
const OneItemHistory = ({item}) => {
  ...
  const approve_data = useSelector(
    state => state.HRRE004_TangCaReducer.TinhTrangPheDuyet,
  );
  ...
  const comfirmAlert = () => {
    ...
    Alert.alert(
      'Thông báo',
      'Bạn có muốn xoá dữ liệu đăng ký không?',
      [
        {
          text: 'Hủy bỏ',
