...
import DKNCC from "./DangKy";
import DS from "./DanhSach";

const DangKyNhanComChay = ({ navigation: { goBack } }) => {
    ...
    <Block flex backgroundColor={Color.backgroundColor}>
      <TVSHeader goBack={goBack}>
        {setHeaderChil2(
          ...
          "MBHRRE015",
          menuReducer.data.data.menu.filter((x) => x.menu_cd === "MBHRRE015")[0]
            .p_pk
        )}
      </TVSHeader>
          ...
          data={[
            {
              ...
              name: "Đăng ký",
              count: null,
              screen: <DKNCC onCallbackReload={onCallbackReload} />,
            },
            {
              id: 1,
              name: "Danh sách",
...
export default DangKyNhanComChay;
