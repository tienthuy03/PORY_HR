...
export default function DK({ onCallbackReload }) {
  ...
  const [isHideApprove, setIsHideApprove] = useState("N");
  const getStateRegType = (result) => {
    ...
    setIsHideApprove(result.hide_approver);
  ...
  const onSave = () => {
    ...
    const in_par = {
      ...
      p8_varchar2: ghiChu,
      p9_varchar2:
        isHideApprove == "Y" ? "" : currentSelectedPerson.approve_role_type,
      p10_varchar2:
        isHideApprove == "Y" ? "" : currentSelectedPerson.thr_emp_pk.toString(),
          ...
          {!isLoading && (
            ...
            >
              <Block style={styles.container}>
                ...
                >
                  <Block style={styles.titleContainer}>
                    {/* <Block style={styles.titleText}>
                      <Text color={Color.mainColor}>Ngày bắt đầu sử dụng</Text>
                ...
                <Block style={styles.titleContainer}>
                  <Block style={styles.titleText}>
                    <Text color={Color.mainColor}>Loại đăng ký</Text>
                    <Text color={Color.red}> *</Text>
                  </Block>
                  <TVSList
                    onPress={() => setModalVisibleRegType(true)}
                    colorText={
                      regType_code_nm == "Chọn loại đăng ký" ? "#B2B2B2" : null
                    }
                    code_nm={regType_code_nm}
                  />
                </Block>
                <Block style={styles.titleContainer}>
                  <Block style={styles.titleText}>
